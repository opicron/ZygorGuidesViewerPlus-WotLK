...
ZygorGuidesViewer:RegisterGuide("Corey's GarryOwen Dailies Guide\\GarryOwen\\Burning Crusade GarryOwen Dailies",[[
...
ZygorGuidesViewer:RegisterGuide("Corey's Alliance Quest Guides\\Reputation\\Cenarion Expedition Reputation",[[
